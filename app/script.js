...
botao_dados.addEventListener('click', async ()=>{
    ...
    const response = await fetch('./src/php/dados_pessoal.php',
        {  
            method: 'GET', 
...
botao_agendamentos.addEventListener('click', async ()=>{
    ...
    const response = await fetch('./src/php/agendamentos.php',
        {  
            method: 'POST', 
            headers: {'Content-Type': 'application/json'},
...
botao_agendar.addEventListener('click', async ()=>{
    ...
    const response = await fetch('./src/php/cadastro_agendamento.php',
        {  
            method: 'POST', 
            headers: {'Content-Type': 'application/json'},
...
async function buscarMedicos(){
    ...
    const response = await fetch('./src/php/medicos.php');
    const data = await response.json();
